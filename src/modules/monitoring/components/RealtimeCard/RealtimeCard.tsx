...
export function RealtimeCard({ item, index }: RealtimeCardProps) {
  ...
  return (
    <AnimatedCard index={index} className="relative overflow-hidden rounded-xl bg-slate-900/80 border border-slate-800/60 p-3 hover:border-slate-700/60 transition-colors duration-300">
