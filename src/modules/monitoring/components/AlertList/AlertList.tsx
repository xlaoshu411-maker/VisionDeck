...
export function AlertList({ alerts }: AlertListProps) {
  if (alerts.length === 0) {
    return (
      <div className="rounded-xl bg-white/10 backdrop-blur-2xl border border-white/15 p-4 text-center">
  ...
  return (
    <div className="rounded-xl bg-white/10 backdrop-blur-2xl border border-white/15 overflow-hidden">
